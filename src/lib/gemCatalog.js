...
export const SHAPES = [
  { id: 'round',    name: 'Круглый',     nameEn: 'Round',    nameUk: 'Круглий' },
  { id: 'princess', name: 'Принцесса',   nameEn: 'Princess', nameUk: 'Принцеса' },
  { id: 'cushion',  name: 'Кушон',       nameEn: 'Cushion',  nameUk: 'Кушон' },
  { id: 'oval',     name: 'Овал',        nameEn: 'Oval',     nameUk: 'Овал' },
  { id: 'emerald',  name: 'Изумрудная',  nameEn: 'Emerald',  nameUk: 'Смарагдова' },
  { id: 'radiant',  name: 'Радиант',     nameEn: 'Radiant',  nameUk: 'Радіант' },
  { id: 'marquise', name: 'Маркиз',      nameEn: 'Marquise', nameUk: 'Маркіз' },
  { id: 'pear',     name: 'Груша',       nameEn: 'Pear',     nameUk: 'Груша' },
  { id: 'heart',    name: 'Сердце',      nameEn: 'Heart',    nameUk: 'Серце' },
  { id: 'asscher',  name: 'Ашер',        nameEn: 'Asscher',  nameUk: 'Ашер' },
  { id: 'trillion', name: 'Треугольник', nameEn: 'Trillion', nameUk: 'Трикутник' },
]

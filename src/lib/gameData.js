...
export const LEVELS = [
  { id:0, name:'Бездомный', sub:'Улица', emoji:'🏚', nstPerTap:0.3,
    ...
    thoughts:[
      'Жизнь проходит мимо... Работа-дом, дом-работа. А что дальше?',
      'Стоп! Ты нашёл шанс изменить всё. Не упусти его!',
      'Подключи кошелёк — сохрани свои первые CHT навсегда!',
      'Без регистрации всё что натапал — испарится через 30 минут...',
      'Пройди регистрацию — и начнётся путь к собственному дому!'

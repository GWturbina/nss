    ...
    <div className="px-3 mt-2 space-y-2">
      ...
      {tab === 'club' && (
        <div className="p-3 rounded-2xl glass space-y-3">
          ...
          <div>
            <div className="flex justify-between mb-1">
              <span className="text-[10px] text-white font-bold">Макс. бонус за NST</span>
          ...
          <div>
            <div className="flex justify-between mb-1">
              <span className="text-[10px] text-white font-bold">NST на 1% скидки</span>
              <span className="text-[13px] font-black text-purple-400">{nstPer} NST</span>
            </div>
            ...
            <div className="text-[8px] text-slate-600 mt-1">Пример: {nstPer * 2} NST = +2% доп. скидка</div>
          </div>

          <div className="p-2.5 rounded-xl bg-emerald-500/8 border border-emerald-500/15">
            <div className="text-[9px] text-emerald-400 font-bold mb-1">Итого для клиента с {nstPer * nstMax} NST:</div>
            <div className="text-[10px] text-white">
              Розничная −{clubDisc}% (базовая) −{nstMax}% (NST) = <span className="font-bold text-gold-400">−{clubDisc + nstMax}% от розницы</span>
            </div>
          </div>
        </div>
      )}

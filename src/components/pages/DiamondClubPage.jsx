      ...
      <div className="w-full max-w-md max-h-[85vh] rounded-2xl overflow-hidden flex flex-col"
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 text-[12px] text-slate-300 leading-relaxed">
          ...
          {tab === 'staking' && (<>
            ...
            <p>Базовая ставка — 50% годовых. Сжигая токены NST в разделе «Буст», вы повышаете ставку:</p>
          ...
          {tab === 'boost' && (<>
            ...
            <p>Сжигая токены NST, вы навсегда увеличиваете свою ставку стейкинга. NST уничтожаются безвозвратно — это повышает ценность оставшихся токенов.</p>

            <HelpTitle emoji="🔥" text="Как это работает" />
            <HelpSteps steps={[
              'Перейдите в раздел «Буст»',
              'Введите количество NST для сжигания',

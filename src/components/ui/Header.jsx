    ...
    <div className="sticky top-0 z-50 border-b" style={{ background: 'var(--bg-card)', borderColor: 'var(--border)' }}>
      ...
      <div className="flex items-center gap-2 px-3 py-2">
        ...
        <div className="flex-1">
          <h1 className="text-sm font-black leading-tight" style={{ color: 'var(--gold)' }}>{t('appName')}</h1>
          <p className="text-[9px]" style={{ color: 'var(--muted)' }}>{t('appSlogan')}</p>
        </div>
      ...
      <div className="flex gap-1.5 px-3 pb-2 overflow-x-auto scrollbar-hide">
        {[
          ...
          const s = {
            ...
            slate: { bg: 'rgba(255,255,255,0.04)', bc: 'rgba(255,255,255,0.08)', tc: 'var(--muted)' }
          }[c]
          return (
